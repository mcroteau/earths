<style>
    ...
    .hln{font-size:32px;font-family:Roboto !important; line-height:1.5em;font-weight: 300;margin-top:20px;width:100%}
    .hln mark{font-size:32px;font-weight:700;font-family:Roboto !important; }
    .count{float:left; width:320px; margin-right:40px;border:solid 1px #ff0000}
    .count p{width:100%;}
...
<div class="casa">
    ...
    <div class="glideleft">
        ...
        <div class="count">9.13M+
            <p class="count-details">People die each year from <br/> hunger
